-- Create "extensions" schema and move pgvector there to satisfy linter
create schema if not exists extensions;
-- Move the extension if it's currently in public
alter extension if exists vector set schema extensions;

-- Recreate match_notes with fixed search_path
